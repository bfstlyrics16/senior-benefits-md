      ...
      <div className="page-wrap">
        ...
        <section className="section">
          <div className="container grid grid-2" style={{alignItems:"start"}}>
            ...
            <div className="card">
              <img src="/maze.jpg" alt="Two seniors in a maze" />
            </div>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container grid grid-3">
            <article className="card" style={{textAlign:"center"}}>
              ...
              <p className="muted">“This workshop was much easier to understand than other sessions we’ve attended.”</p>
          ...
          <div className="container">
            ...
            <div className="grid grid-2">
              <div>
                ...
                <p className="muted">Aetna, Ace Property & Casualty Ins. Co., Aflac, Bankers Fidelity Assurance Company, CareFirst BlueCross BlueShield of Maryland, Cigna, Humana, Mutual of Omaha, United Healthcare (AARP), United American Life Ins. Co., and many more.</p>
              </div>
              <div>
